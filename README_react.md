...
```bash
$ git clone git@github.com:IBM-Cloud/logistics-wizard-webui.git
// or
$ wget -O logistics-wizard-webui.zip https://github.com/IBM-Cloud/logistics-wizard-webui/archive/master.zip
